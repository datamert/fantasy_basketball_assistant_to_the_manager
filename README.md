...
Fantasy Basketball is a game where players become virtual GMs, assembling rosters of real NBA stars whose on-court performances directly impact fantasy outcomes. But most managers are stuck with the same surface-level stats offered by their platforms i.e. data that’s public, predictable, and powerless when it comes to gaining a competitive edge.

That’s where the Assistant (or Assistant to the Manager—shoutout to Dwight Schrute from The Office) steps in. It’s designed to be your behind-the-scenes strategist, offering data-driven intelligence to guide key decisions—from draft day steals to mid-season trades.

This project is a bold attempt to fill the gap between generic analytics and true strategic advantage. Because in fantasy basketball, winning isn’t just about watching the game—it’s about outsmarting it.
